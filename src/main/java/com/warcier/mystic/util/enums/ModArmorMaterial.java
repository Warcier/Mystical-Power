...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    MYSTIC_PEARL(Mystic.MODID + ":mystical",25, new int[] {2,5,6,2},18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,0,() -> {return Ingredient.fromItems(ModItems.MYSTIC_PEARL.get());},0);
